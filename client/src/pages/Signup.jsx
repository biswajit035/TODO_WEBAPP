  ...
  return (
    ...
    <div className='signup border-2 border-red h-full w-full  lg:w-[40vw] md:h-fit md:w-[60vw] p-5 flex flex-col items-center shadow-2xl'>
      ...
      <form action="" className='text-2xl flex flex-col '>
        ...
        <input className='border-2 h-10 rounded-3xl p-5 mb-5 focus:outline-none focus:border-blue-500  ' type="text" id='name' name='name' placeholder='Enter your name' required />
        {/* Email */}
        ...
        {/* signup button */}
        <button type="submit" className='bg-blue-500 text-white px-10 py-2 rounded-full hover:bg-blue-600'>Sign up</button>
      </form>
